class Game{
	...
	loadObject(loader, model) {
		loader.load(`${this.assetsPath}fbx/models/${model}.fbx`, function(object){
	...
	loadEnvironment(loader){
		const game = this;
		for (let model of this.memberModels) {
			let collider = this.loadObject(loader, model);
			game.modelColliders.push(collider);
		}
		console.log('model colliders', game.modelColliders.length)
		loader.load(`${this.assetsPath}fbx/environment/town.fbx`, function(object){
	...
	updateRemotePlayers(dt){
		...
		for (let collider of this.modelColliders) {
			remoteColliders.push(collider)
		}
